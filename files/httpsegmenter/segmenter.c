 ...
 * Modified by Allister Sturgeon, FPS-Tech (c) 2011
 *
...
/* Check defines for different versions of FFMPEG to ensure back/forward compatibility */
...
int main(int argc, char **argv)
{
    ...
    *dot = '.';
    ...
    /* Set the analyze-duration to 0 here for streaming */
    ...
    #if ((LIBAVFORMAT_VERSION_MAJOR >= 52 && LIBAVFORMAT_VERSION_MINOR >= 45) || (LIBAVFORMAT_VERSION_MAJOR >= 53))
